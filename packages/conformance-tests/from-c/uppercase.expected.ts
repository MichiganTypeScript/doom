...
type $entry = Satisfies<Func, {
  ...
  result: 'i32';
    ...
    instructions: [
      ...
      { kind: 'LocalGet'; id: '$l3' },
      { kind: 'LocalGet'; id: '$p0' },
      { kind: 'Store'; subkind: 'I32Store8'; offset: '00000000000000000000000000001111' },
      { kind: 'LocalGet'; id: '$l3' },
      { kind: 'Load'; subkind: 'I32Load8u'; offset: '00000000000000000000000000001111' },
      { kind: 'LocalSet'; id: '$l4' },
      ...
      { kind: 'LocalGet'; id: '$l9' },
      { kind: 'LocalGet'; id: '$l8' },
      { kind: 'Store'; subkind: 'I32Store8'; offset: '00000000000000000000010000000000' },
      { kind: 'Const'; value: '00000000000000000000000000000000' },
      ...
      { kind: 'Store'; subkind: 'I32Store8'; offset: '00000000000000000000010000000001' },
