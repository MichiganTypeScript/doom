...
import type { entry } from './single-i64add.actual'
import { t, T, Ops } from '../../ts-type-math/test-cases/arithmetic-i64'

import { test, expect } from 'vitest';
import { getWasm } from '../utils'

test.each(t)('add($a, $b) === $add', async ({ a, b, add }) => {
  const entry = await getWasm<Ops['add']>("from-wat-single", 'single-i64add');
...
type tests = [
  ...
  Expect<Equal<entry<[T[ 78]['a'], T[ 78]['b']]>, T[ 78]['add']>>,
  Expect<Equal<entry<[T[ 79]['a'], T[ 79]['b']]>, T[ 79]['add']>>,
  Expect<Equal<entry<[T[ 80]['a'], T[ 80]['b']]>, T[ 80]['add']>>,
  Expect<Equal<entry<[T[ 81]['a'], T[ 81]['b']]>, T[ 81]['add']>>,
  Expect<Equal<entry<[T[ 82]['a'], T[ 82]['b']]>, T[ 82]['add']>>,
  Expect<Equal<entry<[T[ 83]['a'], T[ 83]['b']]>, T[ 83]['add']>>,
  Expect<Equal<entry<[T[ 84]['a'], T[ 84]['b']]>, T[ 84]['add']>>,
  Expect<Equal<entry<[T[ 85]['a'], T[ 85]['b']]>, T[ 85]['add']>>,
  Expect<Equal<entry<[T[ 86]['a'], T[ 86]['b']]>, T[ 86]['add']>>,
  Expect<Equal<entry<[T[ 87]['a'], T[ 87]['b']]>, T[ 87]['add']>>,
  Expect<Equal<entry<[T[ 88]['a'], T[ 88]['b']]>, T[ 88]['add']>>,
  Expect<Equal<entry<[T[ 89]['a'], T[ 89]['b']]>, T[ 89]['add']>>,
  Expect<Equal<entry<[T[ 90]['a'], T[ 90]['b']]>, T[ 90]['add']>>,
  Expect<Equal<entry<[T[ 91]['a'], T[ 91]['b']]>, T[ 91]['add']>>,
  Expect<Equal<entry<[T[ 92]['a'], T[ 92]['b']]>, T[ 92]['add']>>,
  Expect<Equal<entry<[T[ 93]['a'], T[ 93]['b']]>, T[ 93]['add']>>,
  Expect<Equal<entry<[T[ 94]['a'], T[ 94]['b']]>, T[ 94]['add']>>,
  Expect<Equal<entry<[T[ 95]['a'], T[ 95]['b']]>, T[ 95]['add']>>,
  Expect<Equal<entry<[T[ 96]['a'], T[ 96]['b']]>, T[ 96]['add']>>,
  Expect<Equal<entry<[T[ 97]['a'], T[ 97]['b']]>, T[ 97]['add']>>,
  Expect<Equal<entry<[T[ 98]['a'], T[ 98]['b']]>, T[ 98]['add']>>,
  Expect<Equal<entry<[T[ 99]['a'], T[ 99]['b']]>, T[ 99]['add']>>,
  Expect<Equal<entry<[T[100]['a'], T[100]['b']]>, T[100]['add']>>,
  Expect<Equal<entry<[T[101]['a'], T[101]['b']]>, T[101]['add']>>,
  Expect<Equal<entry<[T[102]['a'], T[102]['b']]>, T[102]['add']>>,
  Expect<Equal<entry<[T[103]['a'], T[103]['b']]>, T[103]['add']>>,
  Expect<Equal<entry<[T[104]['a'], T[104]['b']]>, T[104]['add']>>,
  Expect<Equal<entry<[T[105]['a'], T[105]['b']]>, T[105]['add']>>,
  Expect<Equal<entry<[T[106]['a'], T[106]['b']]>, T[106]['add']>>,
  Expect<Equal<entry<[T[107]['a'], T[107]['b']]>, T[107]['add']>>,
  Expect<Equal<entry<[T[108]['a'], T[108]['b']]>, T[108]['add']>>,
  Expect<Equal<entry<[T[109]['a'], T[109]['b']]>, T[109]['add']>>,
  Expect<Equal<entry<[T[110]['a'], T[110]['b']]>, T[110]['add']>>,
  Expect<Equal<entry<[T[111]['a'], T[111]['b']]>, T[111]['add']>>,
  Expect<Equal<entry<[T[112]['a'], T[112]['b']]>, T[112]['add']>>,
