import type { Compare as NumbersCompare } from '../../numbers/impl/compare'
import type { StringToTuple } from "./split";
import type { Equal as _Equal } from "../../helpers";
...
> = Char1 extends Char2
  ...
  ? Char2 extends keyof ascii
    ? NumbersCompare<ascii[Char1], ascii[Char2]>
    : 1
  : -1;
