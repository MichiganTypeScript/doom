 ...
 * And the `I` prefixing is not hungarian notation.. it's just to prevent naming collisions.
 * That's all.
 */
...
> =
  ...
  : instruction extends IDivide    ? Instructions.Divide<instruction, state>
  : instruction extends IRemainder ? Instructions.Remainder<instruction, state>

  /* Conversion Instructions */

  /* Floating Point Specific Instructions */
  : instruction extends IAbsoluteValue ? Instructions.AbsoluteValue<instruction, state>
